  ...
  return (
    <>
      ...
      <footer className="site-footer">
        <a href="https://github.com/jwilsson" className="footer__link">
          <span className="footer__label">GitHub</span>

          <svg className="footer__icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="https://www.linkedin.com/in/jwilsson" className="footer__link">
